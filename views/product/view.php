    ...
    <div class="container">
        <ul>
            ...
            <li>
                ...
                <?= \yii\helpers\Html::a($product->category->title,['category/view', 'id' => $product->category->id]) ?> <span>|</span>
            </li>
            ...
            <div class="col-md-8 agileinfo_single_right">
                ...
                <div class="snipcart-item block">
                    ...
                    <div class="snipcart-details agileinfo_single_right_details">
                        <a href="<?= \yii\helpers\Url::to(['card/add', 'id' => $product->id]) ?>" data-id = "<?= $product->id?>" class="button add-to-card"> Add to cart</a>
                    </div>
                </div>
            </div>
